...
class TrafficPoolError(Exception): ...


class PoolNameAlreadyExistsError(TrafficPoolError): ...


class PoolSquadAlreadyUsedError(TrafficPoolError): ...


class PoolSquadNotFoundError(TrafficPoolError): ...


class PoolInUseError(TrafficPoolError):
    """A pool still referenced by at least one plan cannot be deleted."""
