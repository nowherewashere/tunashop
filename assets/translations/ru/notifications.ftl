...
ntf-invite =
    ...
    .withdraw-below-min = 💰 Вывод в крипту — от { $min } ₽. Не хватает ещё { $remaining } ₽. Приглашай друзей (процент падает на баланс) или оплати балансом свою подписку.
    ...
    .stars-no-telegram = ⭐ <i>Чтобы получить Stars, привяжи Telegram. Или выведи в крипту.</i>
