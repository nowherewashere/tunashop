...
btn-promocodes =
    .save = ✅ Сохранить
    .create = 🆕 Создать секретный код
    .confirm = ✅ Создать секретный код
    .delete = 🗑️ Удалить
...
btn-plans =
    ...
    .locations = 🚩 Локации
    .locations-remove = ❌ Удалить текущие локации
    .type = 🔖 Тип
    .availability = ✴️ Доступ
...
btn-subscription =
    ...
    .promocode-goto = 🧾 Подписка
    .promocode-retry = ↩️ Ввести заново
    .pay = 💳 Оплатить
