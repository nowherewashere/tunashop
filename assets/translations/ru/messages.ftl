...
msg-promocode-reset-warning =
    ⚠️ <i>Бонус действует до следующего продления подписки — при продлении лимит вернется к значению плана.</i>

msg-promocode-replace-warning =
    ⚠️ <i>У вас уже есть активная подписка. Она будет заменена новым планом, текущий остаток дней и трафик будут сброшены.</i>
